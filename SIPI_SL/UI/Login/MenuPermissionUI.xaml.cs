    ...
    public partial class MenuPermissionUI : Window
    {
        ...
        private void cmbModuleName_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            try
            {
                ...
                {
                    if ((cmbModuleName.SelectedItem as ESModulePermission).ModuleName.Trim() == "Admission")
                    {
                        AdmissionDashBoard AdmissionDashobj = new AdmissionDashBoard();
                        mnu.Items.Clear();
                        mnu = AdmissionDashobj.GetAllAdmissionMainMenu();
                    }
